...
public abstract class BaseQueryDslRepository<T, ID extends Serializable> extends QueryDslRepositorySupport {

	protected JpaQueryDslRepository<T, ID> repository;
	
	public BaseQueryDslRepository(Class<?> domainClass, JpaQueryDslRepository<T, ID> repository) {
		super(domainClass);
		this.repository = repository;
	}

	
	public JpaQueryDslRepository<T, ID> getRepository() {
	...
	public JPAQuery<T> query() {
		return new JPAQuery<T>(getEntityManager());
	}
